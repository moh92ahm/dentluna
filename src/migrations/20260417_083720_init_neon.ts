...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "_treatments_v" ADD CONSTRAINT "_treatments_v_version_hero_image_id_media_id_fk" FOREIGN KEY ("version_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_doctors_v" ADD CONSTRAINT "_doctors_v_version_profile_image_id_media_id_fk" FOREIGN KEY ("version_profile_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "gallery" ADD CONSTRAINT "gallery_category_id_gallery_category_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."gallery_category"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "gallery" ADD CONSTRAINT "gallery_after_image_id_media_id_fk" FOREIGN KEY ("after_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_gallery_category_fk" FOREIGN KEY ("gallery_category_id") REFERENCES "public"."gallery_category"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "treatments_hero_image_idx" ON "treatments" USING btree ("hero_image_id");
  ...
  CREATE INDEX "_treatments_v_version_version_hero_image_idx" ON "_treatments_v" USING btree ("version_hero_image_id");
  ...
  CREATE INDEX "_doctors_v_version_version_profile_image_idx" ON "_doctors_v" USING btree ("version_profile_image_id");
  ...
  CREATE INDEX "_doctors_v_autosave_idx" ON "_doctors_v" USING btree ("autosave");
  ...
  CREATE INDEX "gallery_after_image_idx" ON "gallery" USING btree ("after_image_id");
  ...
  CREATE UNIQUE INDEX "gallery_category_slug_idx" ON "gallery_category" USING btree ("slug");
  CREATE INDEX "gallery_category_updated_at_idx" ON "gallery_category" USING btree ("updated_at");
  CREATE INDEX "gallery_category_created_at_idx" ON "gallery_category" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_gallery_category_id_idx" ON "payload_locked_documents_rels" USING btree ("gallery_category_id");
